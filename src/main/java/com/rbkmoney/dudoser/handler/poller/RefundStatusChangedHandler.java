...
public class RefundStatusChangedHandler extends InvoicePaymentStatusChangedHandler {
    ...
    public RefundStatusChangedHandler(TemplateDao templateDao, TemplateService templateService, PaymentPayerDaoImpl paymentPayerDaoImpl, MailSenderService mailSenderService) {
