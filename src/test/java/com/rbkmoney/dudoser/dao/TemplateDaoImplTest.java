...
public class TemplateDaoImplTest extends AbstractIntegrationTest {
    ...
    public void getTemplateBodyByMerchShopParams() {
        ...
        template = templateDao.getTemplateBodyByMerchShopParams(EventTypeCode.PAYMENT_STATUS_CHANGED_REFUNDED, "1", "2");
        Assert.assertNotNull(template);
        Assert.assertTrue(template.isActive());
        ...
        template = templateDao.getTemplateBodyByMerchShopParams(EventTypeCode.PAYMENT_STATUS_CHANGED_REFUNDED, "d6f1c81f-7600-4aae-aa59-5a79fe634a3d", "3ad07fb1-56e4-47c3-8c7d-a9521b7ce70e");
        Assert.assertNotNull(template);
        Assert.assertFalse(template.isActive());
    }
}
