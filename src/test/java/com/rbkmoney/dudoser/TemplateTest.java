...
public class TemplateTest extends AbstractIntegrationTest {
    ...
    public void cebTemplateTest() {
        ...
        Assert.assertTrue(filledContent.contains("10000.00 RUB"));
        Assert.assertTrue(filledContent.contains("0.01 RUB"));
        Assert.assertTrue(filledContent.contains("1.11 RUB"));
    }
